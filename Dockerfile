...
COPY --chown=monitor:monitor --chmod=0444 VERSION newapi_monitor.py dashboard_auth.py dashboard_data.py dashboard_http.py dashboard_key_groups.py dashboard_key_usage.py dashboard_newapi_console.py dashboard_settings.py dashboard_setup.py dashboard_sso.py dashboard_time_range.py dashboard_app.py ./
