...
WORKER_SETTING_KEYS = {
    ...
    "channel_failure_window_threshold", "channel_recovery_success_threshold", "log_interval_seconds",
    "resource_interval_seconds", "report_interval_seconds", "log_overlap_seconds",
    "log_initial_lookback_seconds", "slow_request_seconds", "latency_first_response_seconds",
    "latency_window_size", "latency_failure_threshold", "latency_recovery_success_threshold",
    "channel_slow_seconds", "resource_sustain_seconds",
